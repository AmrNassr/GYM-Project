...
public class employeetypes extends javax.swing.JFrame {
Connection con ;
    ...
    public employeetypes() throws ParseException {
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO gym.employeetypes (name) VALUES ('"+namee+"')";
